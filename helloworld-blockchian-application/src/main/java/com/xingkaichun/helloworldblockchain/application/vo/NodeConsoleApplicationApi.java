...
public class NodeConsoleApplicationApi {
    ...
    //查询所有节点
    public static final String QUERY_ALL_NODE_LIST = "/Api/NodeConsoleApplication/QueryAllNodeList";
    ...
    //删除区块
    public static final String DELETE_BLOCK = "/Api/NodeConsoleApplication/DeleteBlock";
