...
public class WalletApplicationApi {
    ...
    //查询所有的账户
    public static final String QUERY_ALL_ACCOUNT_LIST = "/Api/WalletApplication/QueryAllAccountList";



    //构建交易
    public static final String BUILD_TRANSACTION = "/Api/WalletApplication/BuildTransactionDto";
    //提交交易到区块链网络
