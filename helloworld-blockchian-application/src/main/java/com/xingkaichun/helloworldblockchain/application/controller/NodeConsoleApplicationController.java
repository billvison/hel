...
import com.xingkaichun.helloworldblockchain.application.vo.block.DeleteBlockRequest;
import com.xingkaichun.helloworldblockchain.application.vo.block.DeleteBlockResponse;
...
public class NodeConsoleApplicationController {
     ...
     * 查询所有节点
     */
    @RequestMapping(value = NodeConsoleApplicationApi.QUERY_ALL_NODE_LIST,method={RequestMethod.GET,RequestMethod.POST})
     ...
     * 删除区块
     */
    @RequestMapping(value = NodeConsoleApplicationApi.DELETE_BLOCK,method={RequestMethod.GET,RequestMethod.POST})
