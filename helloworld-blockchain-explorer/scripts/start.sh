...
case "$1" in
    start)
        nohup java -Xms1024M -Xmx1024M -Xss512k -verbose:gc -XX:+HeapDumpOnOutOfMemoryError -XX:+PrintGCDetails -Xloggc:logs/gc.log -Dloader.path=lib/,conf/ -Dspring.profiles.active=dev -jar $JAR_NAME &
