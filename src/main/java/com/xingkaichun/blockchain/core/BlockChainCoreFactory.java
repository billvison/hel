...
public class BlockChainCoreFactory {
    ...
    public BlockChainCore createBlockChainCore(String blockchainPath,String minerPublicKeyString) throws Exception {
        ...
        BlockChainDataBase blockChainDataBaseDuplicate = new BlockChainDataBaseDefaultImpl(new File(blockchainPath,"BlockChainDataBaseDuplicate").getAbsolutePath(),incentive,consensus);
